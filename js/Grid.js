...
THREE.Grid = function () {
  ...
  _grid.rotation.x = -Math.PI / 2;
	...
	// x
	var line = new THREE.Line( lineGeometry, new THREE.LineBasicMaterial( { color : 0xff0000 ,linewidth: 2} ) );
	line.rotation.z = - Math.PI / 2;
	line.position.x = -500;
	this.add( line );

	//z
	line = new THREE.Line( lineGeometry, new THREE.LineBasicMaterial( { color : 0x00ff00 ,linewidth: 2 } ) );
